  ...
  return (
    <div className="px-10 py-8">
      ...
      <div className="flex items-start justify-between mb-6">
        ...
        <button className="flex items-center gap-1.5 h-9 px-4 rounded bg-primary text-primary-foreground text-[13px] font-medium hover:bg-primary/90 transition-colors flex-shrink-0">
